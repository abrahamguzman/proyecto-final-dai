...
class PeliculaadminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Pelicula.indexadmin',compact('peliculas'));
    }
    ...
    {
        //
        return view('Pelicula.createadmin');
    }
    ...
    public function store(Request $request)
    {
        ...
        Peliculaadmin::create($request->all());
        return redirect()->route('peliculaadmin.index')->with('success','Registro creado satisfactoriamente');
    ...
    public function edit($id)
    {
        ...
        return view('pelicula.editadmin',compact('pelicula'));
    ...
    public function update(Request $request, $id)
    {
        ...
        Peliculaadmin::find($id)->update($request->all());
        return redirect()->route('peliculaadmin.index')->with('success','Registro creado satisfactoriamente');
    }
